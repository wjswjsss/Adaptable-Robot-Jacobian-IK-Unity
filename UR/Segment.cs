...
public class Segment
{
    ...
    public IKJoint AddJoint(ArticulationBody newBody)
    {
        ...
        {
            // Unity ArticulationBody revolute joint 默认绕局部X轴旋转
            // 实际旋转轴 = anchorRotation * Vector3.right
            // 这样可以自动适配任何机器人（UR3e, Panda等）
            ...
            Debug.Log($"[Segment] {newBody.name} anchorRot={newBody.anchorRotation.eulerAngles}, computedAxis={computedAxis}, jointIndex={this.jointIndex}");
